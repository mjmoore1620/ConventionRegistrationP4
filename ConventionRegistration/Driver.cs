...
//            int patronsProcessed = 0;

//            //nextInLine = new Registrants[(listOfQs.Count)];           //not used
...
//            openTime = new DateTime(2016, 11, 1, 8, 0, 0, 0);
//            closingTime = new DateTime(2016, 11, 1, 18, 0, 0, 0);
...
//            while (currentTime < closingTime || patronsProcessed < patronIdListFromPoisson.Count)
//            {
...
//                    listOfQs[newGuy.lineChoice].Enqueue(newGuy);

//                    Console.WriteLine(newGuy.lineChoice);
...
//                        Console.WriteLine(lineChoice);
//                        Console.WriteLine("assigned wait time: " + windows.Peek().Arrival.windowTime);
//                        Console.WriteLine("time arrived at window: " + windows.Peek().Arrival.Time);
//                        Console.WriteLine("exit time: " + (windows.Peek().Arrival.Time + windows.Peek().Arrival.windowTime));
...
//            Console.WriteLine(patronsProcessed);
//            Console.ReadLine();
//        }
